...
<script>
    ...
    var iso_map = {
        ...
        'GB': { ice_name:'Bretland', tag:'bretland,skotland,england' },
        'DK': { ice_name:'Danmörk', tag:'danmork' },
        'IS': { ice_name:'Ísland', tag:'island' },
        'NO': { ice_name:'Noregur', tag:'noregur,svalbardi' },
        ...
        'TF': { ice_name:'Frönsku suðlægu landsvæðin', tag:'fronsku-sudlaegu-landsvaedin'},
